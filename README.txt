...
Този код е разработен като част от учебен проект и се разпространява под [MIT лиценз](LICENSE).

Молим да цитирате този проект, ако го използвате в своите изследвания или публикации.